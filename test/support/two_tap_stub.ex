defmodule TwoTap.Stub do
  def create_cart(_products) do
    JSON.decode("{\"cart_id\":\"58780e90e2205404b49791b9\",\"message\":\"still_processing\",\"description\":\"Cart is processing.\"}")
  end
  ...
  def start_purchase(_cart_id, _purchase_data) do
    JSON.decode("{\"description\":\"Still processing\",\"message\":\"still_processing\",\"purchase_id\":\"50f414b9e6a4869bf6000010\"}")
  end
